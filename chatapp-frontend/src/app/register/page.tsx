...
export default function RegisterPage() {
    ...
    const { register, loginWithOAuth2 } = useAuth();
    ...
    const handleOAuth2Signup = (provider: 'google' | 'github') => {
        ...
        setError('');
        // OAuth2 login and signup use the same flow — if the user doesn't exist,
        // the backend CustomOAuth2UserService will create a new account automatically
